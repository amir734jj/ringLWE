...
public class PolyTests {
	...
	public void testModPoly() {
		...
		Poly d = new Poly(new BigInteger("7"), 8).plus(new Poly(new BigInteger("3"), 7))
				.minus(new Poly(new BigInteger("5"), 6)).plus(new Poly(new BigInteger("2"), 5))
				.minus(new Poly(new BigInteger("2"), 4)).plus(new Poly(BigInteger.ONE, 3))
				.minus(new Poly(new BigInteger("4"), 2)).minus(new Poly(BigInteger.ONE, 1))
